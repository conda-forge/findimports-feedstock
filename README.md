...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/findimports-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10875&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/findimports-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `findimports` can be installed with:

```
conda install findimports
```

It is possible to list all of the versions of `findimports` available on your platform with:
